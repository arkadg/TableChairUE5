...
public:
	static int Generate3DQuadMesh(const FVector& p_oCenterPoint, double p_dLength, double p_dBreadth, double p_dHeight, TArray<FVector> &p_vfVertices,TArray<int32> &p_viTriangles);
